...
function isSessionExpired(){return __sessExpired}
...
export { loadAuth, saveAuth, clearAuth, getToken, getRefreshToken, getSessionUser, sessionMarkExpired, sessionMarkActive, isSessionExpired, refreshSession, dispatchAuthEvt };
